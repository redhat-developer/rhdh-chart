...
![Version: 5.12.11](https://img.shields.io/badge/Version-5.12.11-informational?style=flat-square)
...
helm install my-backstage redhat-developer/backstage --version 5.12.11
```
...
| global.lightspeed.sidecar.image | Full image reference for the Lightspeed Core sidecar. Override for disconnected environments. | string | `"quay.io/lightspeed-core/lightspeed-stack:0.6.4"` |
