...
When enabled, the chart adds the default Lightspeed dynamic plugins, a RAG bootstrap init container, a Lightspeed Core sidecar listening on port `8080`, chart-generated ConfigMaps, a chart-generated Secret, and separate runtime and RAG data volumes. Override `global.lightspeed.plugins` or the `global.lightspeed.images.ragInit` and `global.lightspeed.images.lightspeedCore` full image references for disconnected environments.
